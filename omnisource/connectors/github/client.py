...
class GitHubClient:
        ...
        try:
            ...
            if isinstance(last_exception, httpx.HTTPStatusError):
                ...
                if status_code == 401 or status_code == 403:
                    ...
                    raise RateLimitError()
            raise NetworkError(f"Request failed after {self.retry_count} attempts: {e}")
            ...
            if status_code == 401 or status_code == 403:
                ...
                raise NetworkError(f"Server error: {status_code}")
            else:
                raise ConnectorError(f"HTTP error: {status_code}", error_code=str(status_code))
    ...
    async def get_readme(self, owner: str, repo: str, ref: str = "main") -> Optional[str]:
    ...
    async def get_license(self, owner: str, repo: str) -> Optional[Dict[str, Any]]:
